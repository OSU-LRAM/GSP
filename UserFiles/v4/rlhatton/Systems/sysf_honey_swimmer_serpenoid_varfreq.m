	...
	switch input_mode
		...
		case 'initialize'
			...
			s.metric = @(x,y,z) LowRE_dissipation_metric_from_general_curvature...
				(@curv_serpenoid_def_test,[x;y;z],1,1,2);  % @(x,y) eye(2);%
...
% 	addpath(genpath('/Users/rlhatton/Documents/MATLAB/LowRE_toolbox/'))
	...
	A = LowRE_local_connection_from_general_curvature(@curv_serpenoid_def_test,[a1;a2;a3],1,1,2);
