function output = shchf_params_triangle_wavelength1_innercontour(input_mode)
	...
	paramfile = 'params_triangle_wavelength1_innercontour';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'params_triangle_wavelength1_innercontour';
