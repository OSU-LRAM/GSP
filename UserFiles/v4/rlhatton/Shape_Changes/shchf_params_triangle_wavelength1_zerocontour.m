function output = shchf_params_triangle_wavelength1_zerocontour(input_mode)
	...
	paramfile = 'params_triangle_wavelength1_zerocontour';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'params_triangle_wavelength1_zerocontour';
