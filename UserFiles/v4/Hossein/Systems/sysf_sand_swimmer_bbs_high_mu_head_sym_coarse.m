function output = sysf_sand_swimmer_bbs_high_mu_head_sym_coarse(input_mode)
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Sandswimmer 3-link high-mu BBs coarse'; % Display name
		...
		case 'initialize'
			...
			s.density.vector = [9]; %density to display vector field
