function output = shchf_kinsnake_pure_trans_alt(input_mode)
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Kinsnake Pure Translation Alternate Demo';
		...
		case 'initialize'
			...
			%path definition
			p.phi_def{1} = {@(t_in)strokedef(t_in,t,stroke_alt)};
			p.dphi_def{1} = {@(t_in)strokedef(t_in,t,dstroke_alt)};
