function output = shchf_sand_pure_trans(input_mode)
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Sandswimmer Pure Translation Demo';
			
		case 'dependency'
			
			output.dependency = {'sandswimmer_pure_trans_def.mat'};
			
		case 'initialize'

			%%%%
			
			load('sandswimmer_pure_trans_def');
