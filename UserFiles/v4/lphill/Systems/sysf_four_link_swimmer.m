function output = sysf_four_link_swimmer(input_mode)
	...
	switch input_mode
		...
		case 'name'
			...
			output = '4-Link Swimmer'; % Display name
...
function A = A_num_helper(a1,a2,a3)
	...
	addpath(genpath('/Users/Suresh/Documents/MATLAB/PhD/curvature_mode_toolbox'))
	addpath(genpath('/Users/Suresh/Documents/MATLAB/PhD/LowRE_toolbox/'))
    addpath(genpath('/Users/Suresh/Documents/MATLAB/PhD/'))
	% Get the local connection for the specified shape, with unit length
	A = Fullconnection(a1,a2,a3);
