function output = sysf_high_ratio_serpenoid(input_mode)
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'High Drag Ratio Serpenoid first modes'; % Display name
...
function A = A_num_helper(a1,a2)
	...
	A = LowRE_local_connection_from_curvature_bases({@serpenoid_1;@serpenoid_2},[a1;a2],1,1,20);
